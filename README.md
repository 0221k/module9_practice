...
<blockquote>2)asgi.py - для развёртывания проекта (новый стандарт).  
<blockquote>3)settings.py - хранит все настройки проекта.  
<blockquote>4)urls.py - пути/ссылки страниц проекта.  
<blockquote>5)wsgi.py - для развёртывания проекта (старый стандарт).  
